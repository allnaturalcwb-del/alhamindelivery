    ...
    <body style="margin:0;padding:0;background:#FFF8F0;font-family:Arial,sans-serif">
      <div style="max-width:560px;margin:0 auto;padding:24px">
        <div style="background:#1C1C1C;border-radius:12px 12px 0 0;padding:20px 24px">
          <div style="color:#F7941D;font-weight:800;font-size:18px">🥕 ALL NATURAL BATEL</div>
        ...
        <div style="background:white;padding:24px;border-radius:0 0 12px 12px">
          ...
          <div style="margin-top:20px;text-align:center">
            <a href="https://allnaturaldelivery.vercel.app/admin"
              style="background:#F7941D;color:white;padding:12px 28px;border-radius:10px;text-decoration:none;font-weight:700;font-size:15px;display:inline-block">
              Acessar o sistema →
            </a>
          </div>
        </div>
